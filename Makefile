...
EXTRA_CFLAGS += -DCONFIG_FPGA_INCLUDED
...
EXTRA_CFLAGS += -DDRV_BB_DBG_TRACE_DISABLE
endif
...
obj-$(CONFIG_RTL8852BS) := $(MODULE_NAME).o
obj-$(CONFIG_RTL8852BS) := $(MODULE_NAME).o
$(MODULE_NAME)-y = $(OBJS)
...
obj-$(CONFIG_RTL8852BS) += $(RTKM_MODULE).o
endif
endif
